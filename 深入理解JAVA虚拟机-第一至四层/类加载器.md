...
使用了ServiceLoader，来加载META-INF\services\java.sql.Driver中所指定的类com.mysql.cj.jdbc.Driver

再来看下DriverManager.getConnection方法
...
这里有一句话 Thread.currentThread().getContextClassLoader(); 是线程上下文类加载器，具体解释见下文
