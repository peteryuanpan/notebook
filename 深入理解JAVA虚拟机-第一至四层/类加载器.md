...
- l.getClassLoader(); 实际获取的是 loader = AppClassLoader.getAppClassLoader(extcl); 因此AppClassLoader是ClassLoader中的getSystemClassLoader()方法的返回值，是一般情况下程序中的默认类加载器
