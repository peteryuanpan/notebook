...
需要指出的是，Java仅仅是没有解决”协程“在Java中的定义，以及“写得优雅“这个问题。可以发现，许多需要“协程”解决的场景问题，都可以用各种各样线程的方式来解决（比如控制线程总数，减少线程stack的大小，用线程池配置max和min idle等），更多的讨论与说明见 https://www.zhihu.com/question/332042250/answer/734115120
