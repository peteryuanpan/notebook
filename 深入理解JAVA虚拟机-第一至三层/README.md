...
- [对象的生命周期](对象的生命周期.md)
  ...
  - [对象的垃圾收集](对象的生命周期.md#对象的垃圾收集)
    - [对象已死判断](对象的生命周期.md#对象已死判断)
    - [垃圾收集算法](对象的生命周期.md#垃圾收集算法)
  - [堆上分配策略](对象的生命周期.md#堆上分配策略)
    - [对象分配在新生代](对象的生命周期.md#对象分配在新生代)
    - [对象进入老年代](对象的生命周期.md#对象进入老年代)
      - [长期存活的对象](对象的生命周期.md#长期存活的对象)
      - [动态年龄判断](对象的生命周期.md#动态年龄判断)
      - [大对象直接进入](对象的生命周期.md#大对象直接进入)
      - [空间分配担保](对象的生命周期.md#空间分配担保)
  - [栈上分配策略](对象的生命周期.md#栈上分配策略)
    - [逃逸分析与标量替换](对象的生命周期.md#逃逸分析与标量替换)
