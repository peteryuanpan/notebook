...
32位机子能存储多大数据，是4GB（4 * 1024 * 1024 * 1024 = 2^2 * 2^10 * 2^10 * 2^10 = 2^32），这种情况下一个oop占32位，4个字节，寻址能力是4GB

64位机子，寻址能力是非常非常大，同样的，一个oop占64位，8个字节，寻址能力也非常非常大

但这样会有多余问题
- 654增加了GC开销，64位对象引用需要占用更多的堆空间，留给其他数据的空间将会减少，从而加快了GC的发生，更频繁的进行GC
二，降低CPU缓存命中率，64位对象引用增大了，CPU能缓存的oop将会更少，从而降低了CPU缓存的效率
三，一般情况下，64位完全没有必要，32位寻址能力是4GB，33是8GB，34是16GB，35是32GB，36是64GB，37是128GB，38是256GB，39是512GB，...，试问一下，有哪些机子能达到512GB内存的？一般家用机子 8GB 和 16GB 最多了吧？服务器机子可能还会达到64GB
