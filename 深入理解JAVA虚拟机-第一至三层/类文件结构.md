...
|--|--|--|
|tag|U1|标志，值为5|
|bytes|U4|按照高位在前存储的long值|

例子1
```
[51] Constant_Long_Info(0x05002bdc546291f4b1)
tag: [5(0x05)]
value: [12345678987654321(0x002bdc546291f4b1)]
```

例子2
```
[62] Constant_Long_Info(0x057fffffffffffffff)
tag: [5(0x05)]
value: [9223372036854775807(0x7fffffffffffffff)]
```

CONSTANT_Long_info存储long型数据
- 例子1，long long1 = 12345678987654321L; 中语句的数值
- 例子2，long long4 = Long.MAX_VALUE; 中语句的数值
...
|--|--|--|
|tag|U1|标志，值为6|
|bytes|U4|按照高位在前存储的double值|

例子1
```
[68] Constant_Double_Info(0x06408f400000000000)
tag: [6(0x06)]
value: [4652007308841189376(0x408f400000000000)]
value_double: [1000.0]
```

例子2
```
[79] Constant_Double_Info(0x067fefffffffffffff)
tag: [6(0x06)]
value: [9218868437227405311(0x7fefffffffffffff)]
value_double: [1.7976931348623157E308]
```

CONSTANT_Double_info存储double型数据
- 例子1，double double1 = 1e3; 中语句的数值
- 例子2，double double4 = Double.MAX_VALUE; 中语句的数值

Java中转换例子，与FLoat的例子类似，将Float类换成Double类
...
例子2
```
[113] Constant_Class_Info(0x07012b)
tag: [7(0x07)]
name_index: [299(0x012b)]
...
例子5
```
[187] Constant_Class_Info(0x070130)
tag: [7(0x07)]
name_index: [304(0x0130)]
...
```
- 例子3，public class VeryUsefulClassFile 当前类的全限定名
- 例子4，子类SubClass1的全限定名
```java
static class SubClass1 {
    int a;
}
```
- 例子5，public VeryUsefulClassFile() throws InterruptedException 语句中 InterruptedException类的全限定名
