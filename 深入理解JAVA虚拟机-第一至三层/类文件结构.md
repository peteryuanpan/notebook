...
try语句
- try语句中无异常
  - 若try语句中无return及throw语句，会执行finally语句并结束
  - 若try语句中有return或throw语句，会先执行finally语句
    - 若finally语句中有return或throw语句，会执行并结束
    - 否则，执行完finally语句后，会回来执行try语句的return语句或throw语句并结束
- try语句中有异常且异常被catch语句捕获，会执行catch语句
- try语句中有异常且异常未被catch语句捕获，会执行finally语句
catch语句
- 若catch语句中无异常
  - 若catch语句中无return及throw语句，会执行finally语句并结束
  - 若catch语句中有return或throw语句，会先执行finally语句
    - 若finally语句中有return或throw语句，会执行并结束
    - 否则，执行完finally语句后，会回来执行catch语句的return语句或throw语句并结束
